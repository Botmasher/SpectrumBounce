...
public class DribbleTestGameManager : MonoBehaviour {
	...
	private class CameraCrew {
		...
		public DribbleTestMusicManager mainMusic;
		
		// instance constructors
		public CameraCrew (Camera cam, Light light, DribbleTestMusicManager music) {
			mainCamera = cam;
			mainLight = light;
			mainMusic = music;
		}
		public CameraCrew () {
			...
			mainMusic = GameObject.FindGameObjectWithTag ("Music").GetComponent<DribbleTestMusicManager> ();
		}
